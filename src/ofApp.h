...
public:
    ...
    ofxAssimpModelLoader asModelObj[100][1000];
    ofMesh modelList[100][1000];
    int modelFlagList[100];
    ofImage modelImageList[100][300];
    int scanTimeRecordList[100][1000][4];
    time_t scanTimeRecordTimeStructureList[100][1000];
    long scanUnixTimeLongIntList[100][1000];
    long scanUnixTimeModelMinList[100];
    long scanUnixTimeModelMaxList[100];
    ...
    int selectedItemIdOnScene[100];
    int scanTimeRecordMaxTime[100];
    double scanGpsDataList[100][1000][8];
    ...
    ofPoint modelSceneMin[100];
    ofPoint modelSceneMax[100];
    ofPoint modelSceneCenter[100];
